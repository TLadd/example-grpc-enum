...
goog.exportSymbol('proto.helloworld.HelloRequest.Value', null, global);
...
proto.helloworld.HelloRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.helloworld.HelloRequest.Value} */ (reader.readEnum());
      msg.setValue(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!proto.helloworld.HelloRequest.Value}
 */
proto.helloworld.HelloRequest.prototype.getValue = function() {
  return /** @type {!proto.helloworld.HelloRequest.Value} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {!proto.helloworld.HelloRequest.Value} value */
proto.helloworld.HelloRequest.prototype.setValue = function(value) {
